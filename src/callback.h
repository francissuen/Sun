...
#define FS_SUN_CALLBACK_REG(cbObj, memFunc, ...) \
    cbObj.RegisterCB(this, std::bind(&memFunc, this, __VA_ARGS__));

#define FS_SUN_CALLBACK_REG_1P(cbObj, memFunc)	\
    FS_SUN_CALLBACK_REG(cbObj, memFunc, std::placeholders::_1)

#define FS_SUN_CALLBACK_REG_2P(cbObj, memFunc)                          \
    FS_SUN_CALLBACK_REG(cbObj, memFunc, std::placeholders::_1, std::placeholders::_2)

#define FS_SUN_CALLBACK_UNREG(cbObj)            \
...
#define FS_SUN_MULTI_CALLBACK_REG(cbObj, triggerKey, memFunc, ...)	\
    cbObj.RegisterCB(triggerKey, this, std::bind(&memFunc, this, __VA_ARGS__));

#define FS_SUN_MULTI_CALLBACK_REG_1P(cbObj, triggerKey, memFunc)	\
    FS_SUN_MULTI_CALLBACK_REG(cbObj, triggerKey, memFunc, std::placeholders::_1);

#define FS_SUN_MULTI_CALLBACK_REG_2P(cbObj, triggerKey, memFunc)	\
    FS_SUN_MULTI_CALLBACK_REG(cbObj, triggerKey, memFunc, std::placeholders::_1, std::Placeholders::_2);

#define FS_SUN_MULTI_CALLBACK_UNREG(cbObj, triggerKey)	\
